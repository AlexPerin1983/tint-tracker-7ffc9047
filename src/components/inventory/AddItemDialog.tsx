  ...
  return (
    <DialogComponent open={open} onOpenChange={onOpenChange}>
      <DialogContentComponent {...contentProps}>
        <DialogHeaderComponent className="p-2 border-b border-slate-800/50 shrink-0 bg-gradient-to-b from-slate-800 to-[#111318]">
        ...
        <div className={cn(
          "flex-1 overflow-y-auto px-2 py-3 space-y-3 scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-[#111318]",
          isMobile && "max-h-[calc(100dvh-6rem)]"
        )}>
          <ItemForm 
            form={form} 
            onSubmit={onSubmit} 
        ...
        <div className="border-t border-slate-800/50 p-2 bg-gradient-to-b from-[#111318] to-slate-800 mt-auto shrink-0">
